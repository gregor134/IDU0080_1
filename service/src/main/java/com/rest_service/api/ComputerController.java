...
public class ComputerController {
    ...
    public ResponseEntity<Computer> getComputer(@PathVariable("id") BigInteger id) {
    ...
    public ResponseEntity<Computer> deleteComputer(@PathVariable("id") BigInteger id) {
